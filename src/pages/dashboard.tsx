  ...
  return (
    <>
      <button
        ...
        className="px-3 py-1.5 rounded-md bg-violet-600 text-white text-xs font-medium hover:bg-violet-500 disabled:opacity-60 flex items-center gap-1.5 shrink-0"
      >
        {isPending ? (
                          ...
                          return (
                            ...
                            >
                              ...
                              <div className="mt-4 flex flex-wrap items-center gap-2">
                                ...
                                {/* Link Jira — only when not linked */}
                                {!jiraLinked && (
                                  <button
                                    type="button"
                                    onClick={() => {
